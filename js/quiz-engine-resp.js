            ...
            <div class="quiz-wrapper">
                ...
                <div class="quiz-screen screen-results">
                    <div class="results-card">
                        ...
                        <div class="results-actions"><button class="quiz-btn quiz-btn-primary btn-restart">${LANG.btnRetake}<span class="icono-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 16 16">
